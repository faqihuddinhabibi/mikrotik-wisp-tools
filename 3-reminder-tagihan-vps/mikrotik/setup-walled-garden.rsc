# Setup walled-garden reminder (SEKALI JALAN) - versi VPS

# ---- GANTI: IP/domain VPS ----
# redirectUrl ADA "/" di akhir. dst-host TANPA "/". Contoh IP: "123.45.67.89"
:local redirectUrl "IP-VPS-ANDA/"
:local pageHost    "IP-VPS-ANDA"
# ------------------------------
...
/ip proxy access add comment="wg-allow-vps" dst-host=$pageHost action=allow
...
:put "Setup walled-garden (VPS) selesai. Pastikan IP-VPS-ANDA sudah diganti."
